		...
		<div id="header" class="container-fluid home">
              <div class="row">
                <div class="header_banner">
                       <div class="slides">
                       		<div class="slider_items parallax-window"  data-parallax="scroll" data-image-src="{{ asset('images/headerimage1.jpg') }}"></div>
                       </div>
                 </div>
             <!-- Header Image Or May be Slider-->
                <div class="top_header">
                    <nav class="navbar navbar-fixed-top">
                         ...
                         <div class="container">
                             <div class="logo">
                                <a href="index.html"><img src="{{ asset('images/logo2.png') }}" alt="Photo" /> </a>
                             </div>
                             <div class="logins">
           ...
           <div class="jobs_results">
              	...
              	<!-- Filters Category --> 
                	<div class="jobs-result"> 
                       <!--Search Result 01-->
					   <div class="col-lg-6">
                        <a href="job-style-one.html"> <div class="filter-result 01">
